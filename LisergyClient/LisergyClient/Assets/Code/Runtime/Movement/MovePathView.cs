...
namespace Assets.Code.Assets.Code.Runtime.Movement
{
    ...
    public class MovePathView
    {
        ...
        public void AddPathObject(Vector3 position, Action<GameObject> onCreated = null)
        {
            ...
            {
                _assets.CreateMapFX(MapFX.HalfPath, position, Quaternion.identity, o =>
                {
                    _pool.AddNew(o);
                    onCreated(o);
                });
        ...
        public void AddPath(TileView addOnTile, Vector3 tilePos, Direction direction)
        {
            if (direction == Direction.SOUTH)
            {
                AddPathObject(new Vector3(tilePos.x, tilePos.y + 0.1f, tilePos.z - 0.25f), o =>
                {
            ...
            {
                AddPathObject(new Vector3(tilePos.x + 0.25f, tilePos.y + 0.1f, tilePos.z), o =>
                {
                    Add(addOnTile.Entity, o);

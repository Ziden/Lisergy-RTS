...
namespace GodotClient
{
    ...
    public static class ClientExtensions
    {
        ...
        {
            var view = GodotServicesContainer.Interface.ServerModules.Views.GetEntityView(entity);
            return (IGodotEntityView)view;
        }

        public static T GetView<T>(this IEntity entity) => (T)GodotServicesContainer.Interface.ServerModules.Views.GetEntityView(entity);
    }
}

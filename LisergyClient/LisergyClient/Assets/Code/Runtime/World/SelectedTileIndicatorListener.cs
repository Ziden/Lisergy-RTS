...
/// </summary>
public class SelectedTileIndicatorListener : IEventListener
{
    private TileEntity _selectedTile;
    private GameObject _tileCursor;
    private IGameClient _client;

    public SelectedTileIndicatorListener(IGameClient client)
    {
        _client = client;
        ...
        IGameClientServices.Assets.CreateMapObject(MapObjectPrefab.Cursor, Vector3.zero, Quaternion.identity, o =>
        {
            o.SetActive(false);
            _tileCursor = o;
        });

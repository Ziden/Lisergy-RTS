...
internal static class BitUtils
{
	...
	{
		for (var num = 31; num >= 0; num--)
		{
			var num2 = (uint) (1 << num);
			if ((n & num2) == num2) return num + 1;
		}
	...
	{
		if (value != 0) return (value >> 3) << 3 == value;
	...
	public static unsafe string PrintBytesHex(byte* buffer, int length)
	{

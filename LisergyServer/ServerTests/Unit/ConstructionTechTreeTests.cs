...
public class TechTreeTests
{
	...
	{
		var node = _game.Specs.ConstructionTechTree.Root.FindElement(e => { return e.Id == TestBuildings.FARM; });
	...
	public void BuildingDependenciesFormCorrectPath()
	{
		...
		if (tile2 == null) Assert.Fail("Could not find a suitable tile for Farm building");

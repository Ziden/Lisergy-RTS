...
public class TestSpecSerialization
{
	...
	public void TestTechTreeSerialization()
	{
		...
		{
			var oldNode = game.Specs.ConstructionTechTree.Root.FindElement(e => { return e.Id == newItem; });
			var newNode = deserialized.Spec.ConstructionTechTree.Root.FindElement(e => { return e.Id == newItem; });

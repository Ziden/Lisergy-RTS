...
namespace Game.Engine.Events
{
	...
	{
		private static readonly Queue<T> _free = new Queue<T>();
		private static readonly HashSet<T> _used = new HashSet<T>();
		...
		public static bool IsUsed(T o)
		{
			return _used.Contains(o);
		}

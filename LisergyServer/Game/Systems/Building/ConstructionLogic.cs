...
namespace Game.Systems.Building
{
	...
	public class ConstructionLogic : BaseEntityLogic<ConstructionWorkerComponent>
	{
		...
		public TimeBlock GetConstructionTimes()
		{
			return CurrentEntity.Get<ConstructionSiteComponent>().BuildingWorkPrediction;
		}
		...
		public IEntity PlaceConstruction(BuildingSpecId buildingSpecId, GameId owner)
		{
			...
			if (Game.Specs.BuildingConstructions.TryGetValue(buildingSpecId, out var constructionSpec) &&

...
{
	public class MovementLogic : BaseEntityLogic<MovementComponent>
	{
		public bool TryStartMovement(Location[] sentPath, CourseIntent intent)
		{
		...
		public GameTask GetCourseTask()
		{
			return Game.Scheduler.GetTask(CurrentEntity.Components.Get<MovementComponent>().CourseId);
		}

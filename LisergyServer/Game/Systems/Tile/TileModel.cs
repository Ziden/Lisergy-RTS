...
namespace Game.Tile
{
    ...
    {
        public IEntity TileEntity { get; protected set; }
        ...
        public ref readonly GameId EntityId => ref TileEntity.EntityId;
        public ComponentSet Components => TileEntity.Components;
        ...
        public EntityLogic Logic => Game.Logic.GetEntityLogic(TileEntity);

...
namespace AStar
{
    ...
    {
        TileVector[] Find(in TileVector start, in TileVector goal);
    }
    ...
    public class AStarSearch : IPathfinder
    {
        ...
        public TileVector[] Find(in TileVector start, in TileVector goal)
        {
            Reset();
            ...
            while (_open.Count > 0)
            {
                ...
                TileVector proposed = new TileVector(0, 0);

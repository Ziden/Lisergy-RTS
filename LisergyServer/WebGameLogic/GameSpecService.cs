...
public class GameSpecService
{
	...
	public Dictionary<byte, BuildingSpec> GetBuildings()
	{
		return GetGameSpec().Buildings;
	}

	public BuildingSpec? GetBuilding(byte id)
	{
		return GetGameSpec().Buildings.TryGetValue(id, out var building) ? building : null;
	}

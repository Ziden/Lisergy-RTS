...
{
	public Dictionary<GameId, IEntityView> GetViews(EntityType t)
	{
		return this[t];
	}
	...
	public IEntityView GetView(IEntity e)
	{
		...
		if (GetViews(e.EntityType).TryGetValue(e.EntityId, out var v)) return v;
		return default!;
	}

	public IEntityView GetView(EntityType t, GameId id)
	{
		if (GetViews(t).TryGetValue(id, out var v)) return v;
		return null!;
	}

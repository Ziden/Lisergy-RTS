...
namespace GameDataTest
{
    public class TestBuildings
    {
        ...
        public static readonly BuildingSpecId CONSTRUCTION_CAMP = 6;

        private static NodeTree<BuildingSpecId> TechNode(BuildingSpecId building,
            params NodeTree<BuildingSpecId>[] children)
        {
        ...
        public static void Generate(ref GameSpec spec)
        {
            ...
            spec.Buildings[CONSTRUCTION_CAMP] = new BuildingSpec(CONSTRUCTION_CAMP)
            {
                Name = "Tavern",
                LOS = 4,
                Art = new ArtSpec { Address = Addr("ConstructionSite") },
